...
//     // Corrected path to point from 'src/routes' to 'src/assets/gallery'
//     cb(null, path.join(__dirname, '../../../../frontend/src/assets/gallery/'));
//   },
//   filename: (_req: Request, file: Express.Multer.File, cb) => {
//     const uniqueSuffix = Date.now() + '-' + Math.round(Math.random() * 1E9);
//     cb(null, `rockstar-${uniqueSuffix}${path.extname(file.originalname)}`);
//   }
// });
